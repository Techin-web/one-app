...
import { Content, ContentImg, Img, Form, Password, PasswordLabel, Error, Footer, Contact, Ball, ContactLabel } from './styles';
        ...
        <Container>
            { !modalVisible
                ?   <Content isIos={isIos}>
                        ...
                        <Form>
                            <Input label={'E-mail ou CPF'} name={'login'} control={control} />
                            {errors.login && <Error>{errors.login.message}</Error>}

                            <Input label={'Senha'} name={'password'} control={control} />
                ...
                :   <Modal visible={modalVisible} message={"Não localizei seu cadastro, tente novamente!"} label={'Voltar'} setModalVisible={setModalVisible} />
            }
        </Container>
    );
}
